...
object PetProfileApiClient {
    ...
    fun getApiService(context: Context): PetProfileApiService {
        return getClient(context).create(PetProfileApiService::class.java)
    }
}